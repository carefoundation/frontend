...
import { ClipboardList, Heart, Users, Award, Map, Loader2, Ticket, X, QrCode, Copy, CheckCircle, Share2 } from 'lucide-react';
                    ...
                    onClick={(e) => {
                      ...
                      if (navigator.share) {
                        navigator.share({
                          ...
                          url: `${window.location.origin}/partners/event-form/${partner._id || partner.id}`,
                        }).catch(() => {});
                      } else {
                        navigator.clipboard.writeText(`${window.location.origin}/partners/event-form/${partner._id || partner.id}`);
